...
module.exports = {
  ...
  CHAT_PRESENCE_JSON: path.join(DATA_DIR, "chatPresence.json"),
  CHAT_OUTBOX_JSON: path.join(DATA_DIR, "chatOutbox.json"),
  ...
  RANKED_QUEUE_JSON: path.join(DATA_DIR, "rankedQueue.json"),
  RANKED_BATTLE_JSON: path.join(DATA_DIR, "rankedBattle.json"),
  OVERLAY_EVENT_QUEUE_JSON: path.join(DATA_DIR, "overlayEventQueue.json"),
