...
const profiles = { users:{ a:{ranked:{mmr:1111}}, b:{ranked:{mmr:987}} } };
...
assert.deepEqual(match.players.map((player) => player.elo), [1111,987]);
assert.deepEqual(match.players.map((player) => player.team.length), [3,3]);
